...
class CategoryQueryDslRepositoryTest extends BaseRepositoryTest {
    ...
    void shouldFetchChildById() {
        List<CategoryDto> result = categoryQueryDslRepository.fetchRecursiveByIds(List.of(category.getId()), false);
    ...
    void shouldFetchRecursiveById() {
        List<CategoryDto> result = categoryQueryDslRepository.fetchRecursiveByIds(List.of(category.getId()), true);
        assertNotNull(result);
        assertFalse(result.isEmpty());
