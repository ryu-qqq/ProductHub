...
@Service
public class ExternalProductGroupHybridRepository implements ExternalProductGroupPersistenceRepository {

    private final ExternalProductGroupJdbcRepository externalProductGroupJdbcRepository;

    public ExternalProductGroupHybridRepository(ExternalProductGroupJdbcRepository externalProductGroupJdbcRepository) {
