...
public class ExternalRequestEntity extends BaseEntity {
    ...
    public ExternalRequestEntity(long transactionId, RequestType requestType, long siteId, EntityType entityType, long entityId, SyncStatus status, String requestBy) {
