...
import static com.ryuqq.setof.storage.db.core.product.group.QProductGroupInsertRequestEntity.productGroupInsertRequestEntity;
...
public class ProductGroupQueryDslRepository implements ProductGroupQueryRepository {
    ...
    public List<Long> fetchIdsByFilter(ProductGroupStorageFilterDto filter){
        return queryFactory
                ...
                .where(
                        ...
                        isProductGroupIdGt(filter.cursorId()),
                        styleCodeEq(filter.styleCode()),
                        productGroupNameLike(filter.productGroupName())
                )
                .orderBy(productGroupEntity.id.asc())
    ...
    @Override
    public List<ProductGroupInsertRequestDto> fetchInsertRequestDtoByIds(List<Long> productGroupIds) {
        return queryFactory.select(
                    new QProductGroupInsertRequestDto(
                            productGroupInsertRequestEntity.productGroupId,
                            productGroupInsertRequestEntity.requestBody
                    )
                )
                .from(productGroupInsertRequestEntity)
                .where(productGroupInsertRequestEntity.productGroupId.in(productGroupIds))
                .fetch();
    }
