...
@Repository
public class ExternalProductGroupQueryDslRepository implements ExternalProductGroupQueryRepository {
    ...
    public List<ExternalProductGroupDto> fetchByIds(List<Long> externalProductIds){
        return queryFactory
                ...
                .leftJoin(externalProductEntity)
                    .on(externalProductEntity.externalProductGroupId.eq(externalProductGroupEntity.externalProductGroupId))
                    .on(externalProductEntity.deleteYn.eq(false))
                                ...
                                new QExternalProductGroupDto(
                                        ...
                                        GroupBy.list(
                                                new QExternalProductDto(
                                                        externalProductEntity.externalProductGroupId.coalesce(""),
                                                        externalProductEntity.externalProductId.coalesce(""),
                                                        externalProductEntity.optionValue.coalesce(""),
                                        ...
                                        GroupBy.list(
                                                new QExternalProductImageDto(
                                                        externalProductImageEntity.id,
                                                        externalProductImageEntity.productGroupId,
                                                        externalProductImageEntity.siteId,
                                                        externalProductImageEntity.externalProductGroupId.coalesce(""),
