...
@Entity
public class ProuctProcessingResultEntity extends BaseEntity {
    ...
    protected ProuctProcessingResultEntity() {}

    public ProuctProcessingResultEntity(long productGroupId, ProductDataType productDataType, String result) {
