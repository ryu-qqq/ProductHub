...
@Component
public class ProductGroupImageCommandFacade implements ProductGroupImagePersistenceService{
    ...
    protected ProductGroupImageCommandFacade(ProductGroupImageJpaRepository productGroupImageJpaRepository, ProductGroupImageJdbcRepository productGroupImageJdbcRepository) {
