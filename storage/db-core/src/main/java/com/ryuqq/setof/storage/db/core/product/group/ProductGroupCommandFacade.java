...
@Component
public class ProductGroupCommandFacade implements ProductGroupPersistenceService {
    ...
    public ProductGroupCommandFacade(ProductGroupJpaRepository productGroupJpaRepository, ProductGroupJdbcRepository productGroupJdbcRepository) {
