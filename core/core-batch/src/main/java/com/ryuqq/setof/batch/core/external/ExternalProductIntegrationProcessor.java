...
import com.ryuqq.setof.batch.core.product.ExternalProductBatchInsertData;
import com.ryuqq.setof.batch.core.product.ExternalProductProcessingData;
...
@Component
public class ExternalProductIntegrationProcessor implements ItemProcessor<List<ExternalProductProcessingData>, ExternalProductBatchInsertData> {
