...
class CrawlProductControllerTest extends RestDocsTest {
    ...
    @InjectMocks
    private CrawlProductController crawlProductController;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        this.mockMvc = mockController(crawlProductController);
    }
