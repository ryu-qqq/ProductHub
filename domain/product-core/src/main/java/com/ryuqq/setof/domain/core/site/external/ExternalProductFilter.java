...
public record ExternalProductFilter(
    ...
    public static ExternalProductFilter of(long siteId,  long sellerId, SyncStatus status, int pageSize) {
    ...
    public ExternalProductStorageFilterDto toStorageFilterDto() {
        return new ExternalProductStorageFilterDto(
